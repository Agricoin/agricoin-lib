...
```js
// Standard testnet
> agricoincore.Networks.testnet.networkMagic;
<Buffer 0b 11 09 07>
```

```js
// Enabling testnet to use the regtest port and magicNumber
> agricoincore.Networks.enableRegtest();
> agricoincore.Networks.testnet.networkMagic;
<Buffer fa bf b5 da>
```
...
Take a look at this modified snippet from [networks.js](https://github.com/Agricoin/agricoin-lib/blob/master/lib/networks.js)
